...
function genderChoose() {
    let gender = prompt("Ваша стать. (1 — чоловіча, 2 — жіноча)");
    switch (gender) {
        case '1':
...
genderChoose();
const childrenChoose = prompt("Вкажіть, скількох дітей Ви б хотіли мати. :)");


const professionChoose = prompt("Ким би Ви хотіли працювати?");


const countryOption = prompt("У якій країні Ви б хотіли жити та працювати?");
